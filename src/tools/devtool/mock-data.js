...
export default {
  ...
  render(container) {
    ...
    const checkboxContainer = createElement('div', { className: 'result-box' })
    GENERATOR_KEYS.forEach(key => {
      ...
      label.appendChild(document.createTextNode(' ' + GENERATORS[key].label))
    ...
    const outputSection = createSection('输出', createElement('div', {}, [tabs, outputEl]), [copyBtn])
